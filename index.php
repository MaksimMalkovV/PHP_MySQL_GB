...
$info = [
    [
        'work_name' => 'Машинист',
        'work_date' => 'Август 2019 - Сентябрь 2020 ',
        'work_descrip' => 'Работа на тепловозе в компании РЖД.',
    ],
    [
        'work_name' => 'Слесарь ЭРГО',
        'work_date' => 'Сентябрь 2020 - Ноябрь 2022',
        'work_descrip' => 'Работа в компании Газпром',
    ],
    [
        'work_name' => 'Студент...',
        'work_date' => 'Ноябрь 2022 - по наст. время',
        'work_descrip' => 'Учусь в ИГЭУ г. Иваново',
    ],
];
